...
This is Jamie’s primary responsibility.
...
This is Stephen’s and Aaron’s responsibility.
...
### /api/prisma – Database Configuration

schema.prisma — database models for Prisma + Supabase
...
### /api/src/core – Shared Infrastructure
config/
...
prisma.service.ts — Prisma client wrapped for NestJS

database.module.ts — makes Prisma injectable across modules
...
### /api/src/modules – Main Logic & Domain Modules
...
Show cluster → house relationships
...
### /api/src/modules/clustering – Clustering Engine (Aaron)

This is where Block’s intelligence lives.
...
## Sprint 1 – Required NPM Dependencies
